...
``ExperimentConfig``/``BaseConfig`` carry the run-level knobs every trainer
needs (seed, device, tracking); ``GrokkingConfig`` extends them with the data,
model, optimiser, and snapshot sub-configs this project needs. The model
